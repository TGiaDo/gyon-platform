...
/**
 * Simulates route progress and sends navigation
 * updates over a companion bridge.
 */
export class RouteSimulator {
  ...
  /**
   * Starts sending navigation updates.
   */
  start(): void {
    this.sendCurrentStep("started");
  }
